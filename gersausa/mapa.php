<?php
// Configuración de la conexión a la base de datos (WAMP)
...
@media (max-width: 1000px) {
    ...
    .cintillo-text { font-size: 8.5px; white-space: nowrap; }
    .cintillo-icon-img { width: 16px; }
    
    .sub-text { font-size: 9px; gap: 4px; }
    .paypal-logo { height: 11px; }
    ...
    .categories-nav {
        ...
        gap: 6px 12px;         /* Espacio controlado entre filas y columnas */
        padding: 10px 5px;     /* Padding ajustado para que el cintillo no sea grueso */
    }

    .cat-item {
        flex: 0 1 auto;        /* Permite ajuste flexible */
        padding: 2px 0;
    }

    .cat-item a {
        font-size: 8px;        /* Tamaño equilibrado: visible pero elegante */
        white-space: nowrap;   /* Mantiene cada categoría en una sola pieza */
...
<body class="bg-slate-50 text-slate-900">
    ...
    <div class="bg-blue-900 text-white py-2 px-4 sticky top-0 z-50 shadow-md">
        <div class="max-w-7xl mx-auto flex justify-between items-center text-xs md:text-sm font-semibold">
            <div class="flex items-center gap-4">
                <span class="flex items-center gap-1"><i data-lucide="phone" class="w-4 h-4 text-blue-300"></i> +52 1 55 8275 3784</span>
    ...
    <header class="glass py-2 px-6 border-b border-slate-200 sticky top-[40px] z-40">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <a href="https://wa.me/5582753784" class="bg-green-500 hover:bg-green-600 text-white px-5 py-2 rounded-full font-bold flex items-center gap-2 transition-all shadow-lg shadow-green-200">
    ...
    <div class="cintillo-container">
        ...
        <div class="cintillo-item">
            ...
            <div class="cintillo-text">
                <span class="title-bold highlight-green">PAGO SEGURO</span>
...
<div class="cintillo-slim categories-bg">
    <div class="cintillo-container">
        <nav class="categories-nav">
            <a href="https://www.gersamex.com/calentadores">CALENTADORES</a>
            <a href="https://www.gersamex.com/pisos-y-recubrimientos">PISOS</a>
            <a href="https://www.gersamex.com/regaderas">REGADERAS</a>
            <a href="https://www.gersamex.com/muebles-y-sanitarios/wc">WC</a>
            <a href="https://www.gersamex.com/muebles-y-sanitarios/lavabos">LAVABOS</a>
            <a href="https://www.gersamex.com/griferia/">GRIFERIA</a>
            <a href="https://www.gersamex.com/tarjas">TARJAS</a>
            <a href="https://www.gersamex.com/iluminacion">LUMINARIA</a>
            <a href="https://www.gersamex.com/wpc?_q=wpc&map=ft">PANEL</a>
            <a href="https://www.gersamex.com/muebles-y-sanitarios/canceles-y-cabinas">CABINAS</a>
            <a href="https://www.gersamex.com/accesorios-de-bano/espejos">ESPEJOS</a>
        </nav>
    </div>
</div>
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="animate-scroll" style="display: flex; gap: 2rem; width: max-content;">
            ...
            <div class="brand-card bg-white/50 border border-slate-200 rounded-2xl p-6 flex items-center justify-center h-32 w-64" style="filter: none !important; opacity: 1 !important;">
                <img src="img/temp/img1.png" alt="Porcelanite" class="max-h-12 w-auto object-contain">
            </div>
            <div class="brand-card bg-white/50 border border-slate-200 rounded-2xl p-6 flex items-center justify-center h-32 w-64" style="filter: none !important; opacity: 1 !important;">
                <img src="img/temp/img2.png" alt="Helvex" class="max-h-10 w-auto object-contain">
            </div>
            <div class="brand-card bg-white/50 border border-slate-200 rounded-2xl p-6 flex items-center justify-center h-32 w-64" style="filter: none !important; opacity: 1 !important;">
                <img src="img/temp/img3.png" alt="Urrea" class="max-h-8 w-auto object-contain">
            </div>
            <div class="brand-card bg-white/50 border border-slate-200 rounded-2xl p-6 flex items-center justify-center h-32 w-64" style="filter: none !important; opacity: 1 !important;">
                <img src="img/temp/img4.png" alt="Calorex" class="max-h-12 w-auto object-contain">
            </div>
            <div class="brand-card bg-white/50 border border-slate-200 rounded-2xl p-6 flex items-center justify-center h-32 w-64" style="filter: none !important; opacity: 1 !important;">
                <img src="img/temp/img5.png" alt="Lamosa" class="max-h-10 w-auto object-contain">
            </div>
            <div class="brand-card bg-white/50 border border-slate-200 rounded-2xl p-6 flex items-center justify-center h-32 w-64" style="filter: none !important; opacity: 1 !important;">
                <img src="img/temp/img6.png" alt="Cato" class="max-h-10 w-auto object-contain">
            </div>

            <div class="brand-card bg-white/50 border border-slate-200 rounded-2xl p-6 flex items-center justify-center h-32 w-64" style="filter: none !important; opacity: 1 !important;">
                <img src="img/temp/img7.png" alt="Porcelanite" class="max-h-12 w-auto object-contain">
            </div>
            <div class="brand-card bg-white/50 border border-slate-200 rounded-2xl p-6 flex items-center justify-center h-32 w-64" style="filter: none !important; opacity: 1 !important;">
                <img src="img/temp/img8.png" alt="Helvex" class="max-h-10 w-auto object-contain">
            </div>
            <div class="brand-card bg-white/50 border border-slate-200 rounded-2xl p-6 flex items-center justify-center h-32 w-64" style="filter: none !important; opacity: 1 !important;">
                <img src="img/temp/img9.png" alt="Urrea" class="max-h-8 w-auto object-contain">
            </div>
            <div class="brand-card bg-white/50 border border-slate-200 rounded-2xl p-6 flex items-center justify-center h-32 w-64" style="filter: none !important; opacity: 1 !important;">
                <img src="img/temp/img10.png" alt="Calorex" class="max-h-12 w-auto object-contain">
            </div>
            <div class="brand-card bg-white/50 border border-slate-200 rounded-2xl p-6 flex items-center justify-center h-32 w-64" style="filter: none !important; opacity: 1 !important;">
                <img src="img/temp/img11.png" alt="Lamosa" class="max-h-10 w-auto object-contain">
            </div>
            <div class="brand-card bg-white/50 border border-slate-200 rounded-2xl p-6 flex items-center justify-center h-32 w-64" style="filter: none !important; opacity: 1 !important;">
                <img src="img/temp/img12.png" alt="Cato" class="max-h-10 w-auto object-contain">
            </div>
        </div>
    </div>
</section>

   <section id="prom" class="py-20 px-6">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            $res_promos = $conn->query("SELECT * FROM promociones ORDER BY id DESC");
            if ($res_promos->num_rows > 0):
                while($p = $res_promos->fetch_assoc()): ?>
                    <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/50 overflow-hidden border border-slate-100 flex flex-col group">
                        <div class="relative overflow-hidden aspect-square">
                            <img src="<?php echo $p['imagen']; ?>" alt="<?php echo $p['titulo']; ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        </div>
                        <div class="p-8 flex-1 flex flex-col">
                            <h3 class="text-xl font-bold mb-2 uppercase"><?php echo $p['titulo']; ?></h3>
                            <p class="text-slate-500 text-sm mb-6 flex-1"><?php echo $p['descripcion']; ?></p>
                            <div class="flex items-center justify-center mb-6">
                                <span class="text-3xl font-black text-red-600 uppercase"><?php echo $p['descuento']; ?></span>
                            </div>
                            <a href="https://wa.me/5582753784?text=Hola,%20me%20gustaría%20pedir%20una%20cotización%20por%20<?php echo urlencode($p['titulo']); ?>" target="_blank">
    ...
    <section id="productos" class="py-20 bg-slate-100 border-y border-slate-200 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6">
        <div id="product-slider" class="carousel-container">
                ...
                <?php
                 // Consulta de Más Vendidos
                $res_vendidos = $conn->query("SELECT * FROM mas_vendidos ORDER BY id DESC");
                  if ($res_vendidos->num_rows > 0):
                        while($v = $res_vendidos->fetch_assoc()): ?>
            <div class="product-card-static bg-white rounded-3xl p-5 border border-slate-100 shadow-sm relative group">
                
                    <?php if(!empty($v['descuento'])): ?>
                <div class="absolute top-8 left-8 z-10 bg-green-500 text-white text-[10px] font-black px-2 py-1 rounded-md uppercase tracking-widest">
                             <?php echo htmlspecialchars($v['descuento']); ?>
                          </div>
                    <?php endif; ?>
                
                    <div class="relative aspect-square mb-4 overflow-hidden rounded-2xl bg-slate-50">
                        <img src="<?php echo htmlspecialchars($v['imagen']); ?>" class="w-full h-full object-cover" alt="<?php echo htmlspecialchars($v['titulo']); ?>">
                     </div>
                
                    <div class="space-y-3">
                        <h4 class="font-bold text-slate-800 text-sm h-10 line-clamp-2 uppercase">
                    ...
                    <div class="flex items-center text-yellow-400 gap-1">
                        <?php 
                        for($i = 0; $i < 5; $i++) {
                            $fill = ($i < $v['estrellas']) ? 'fill-current' : '';
                            echo '<i data-lucide="star" class="w-3 h-3 ' . $fill . '"></i>';
                        }
                        ?>
                        <span class="text-xs text-slate-400 font-bold ml-1">
                            <?php echo number_format($v['estrellas'], 1); ?>
                        </span>
                    </div>
                    
                    <div class="flex flex-col gap-0.5 min-h-[3rem]">
                        <?php if(!empty($v['precio_descuento']) && $v['precio_descuento'] > 0): ?>
                            <span class="text-xs text-slate-400 font-medium line-through price-old" data-base="<?php echo $v['precio']; ?>">
                                Antes: $<?php echo number_format($v['precio'], 2); ?> USD
                            </span>
                            <span class="text-blue-900 font-black text-xl price-val" data-base="<?php echo $v['precio_descuento']; ?>">
                                $<?php echo number_format($v['precio_descuento'], 2); ?> USD
                            </span>
                        <?php else: ?>
                            <span class="text-xs text-transparent select-none font-medium">Fila Limpia</span>
                            <span class="text-blue-900 font-black text-xl price-val" data-base="<?php echo $v['precio']; ?>">
                                $<?php echo number_format($v['precio'], 2); ?> USD
                            </span>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="flex items-center justify-between pt-2 border-t border-slate-50">
                        <div class="flex gap-4 items-center w-full">
                            <?php if(!empty($v['link'])): ?>
                                <a href="<?php echo htmlspecialchars($v['link']); ?>" target="_blank" class="hover:scale-110 transition-transform flex items-center gap-1.5 text-slate-600 hover:text-blue-600 font-medium text-xs" title="Ver producto original">
                                    <img src="img/temp/ojo.png" class="w-6 h-6 object-contain" alt="Ver">
                                    <span>Ver más</span>
                                </a>
                            <?php else: ?>
                                <div class="opacity-30 cursor-not-allowed flex items-center gap-1.5 font-medium text-xs text-slate-400" title="Sin enlace disponible">
                                    <img src="img/temp/ojo.png" class="w-6 h-6 object-contain grayscale" alt="Ver">
                                    <span>Sin Link</span>
                                </div>
                            <?php endif; ?>

                            <a href="https://wa.me/5582753784?text=Hola,%20me%20interesa%20el%20producto:%20<?php echo urlencode($v['titulo']); ?>" target="_blank" class="ml-auto hover:scale-110 transition-transform" title="Preguntar por WhatsApp">
                                <img src="img/temp/whatsapp.png" class="w-6 h-6" alt="WhatsApp">
                            </a>
                        </div>
                    </div>
        ...
        <div class="max-w-7xl mx-auto grid md:grid-cols-3 gap-12">
            ...
            <div>
                ...
                <ul class="text-sm space-y-2">
                    <li><a href="https://www.gersamex.com/privacy" class="hover:text-white">Aviso de Privacidad</a></li>
                    <li><a href="https://www.gersamex.com/shipping" class="hover:text-white">Políticas de Envio y entrega</a></li>
                    <li><a href="https://sites.google.com/gersamex.com.mx/gersamex/catalogos-extendidos" class="hover:text-white">Catálogo extendido</a></li>
                    <li><a href="https://sucursales.gersamex.com/" class="hover:text-white">Nuestras Sucursales</a></li>
                </ul>
            </div>
            <div>
    ...
    <script>
        ...
        const exchangeRate = 18.50; // 1 USD = 18.50 MXN
        ...
        function setCurrency(cur) {
            ...
            if(cur === 'USD') {
                btnUsd.className = "text-white opacity-100 font-bold";
                btnMxn.className = "text-blue-300 opacity-60";
            } else {
                btnMxn.className = "text-white opacity-100 font-bold";
                btnUsd.className = "text-blue-300 opacity-60";
            }
        ...
        function updatePrices() {
            // 1. Actualizar precios principales
            ...
            priceElements.forEach(el => {
                ...
                if (currentCurrency === 'USD') {
                    const usdVal = baseUSD.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
                    el.innerHTML = `$${usdVal} USD${suffix}`;
                } else {
                    const mxnVal = (baseUSD * exchangeRate).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
                    el.innerHTML = `$${mxnVal} MXN${suffix}`;
                }
            });

            // 2. Actualizar precios anteriores (tachados)
            const oldPriceElements = document.querySelectorAll('.price-old');
            oldPriceElements.forEach(el => {
                ...
                if (currentCurrency === 'USD') {
                    const usdVal = baseUSD.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
                    el.innerHTML = `Antes: $${usdVal} USD`;
                } else {
                    const mxnVal = (baseUSD * exchangeRate).toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
                    el.innerHTML = `Antes: $${mxnVal} MXN`;
                }
            });
        }
    </script>
